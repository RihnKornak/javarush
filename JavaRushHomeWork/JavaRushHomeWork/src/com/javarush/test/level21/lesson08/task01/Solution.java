...
public class Solution implements Cloneable{
    ...
    {  // //Map<String, User> cloneUser = new LinkedHashMap();
        Solution sol = new Solution();
        Map<String, User> cloning = new LinkedHashMap();
        for (Map.Entry<String, User> x : users.entrySet()){
            User cloneUser = new User(x.getValue().age, x.getValue().name);
           cloning.put(x.getKey(), cloneUser);
        }
        sol.users = cloning;
