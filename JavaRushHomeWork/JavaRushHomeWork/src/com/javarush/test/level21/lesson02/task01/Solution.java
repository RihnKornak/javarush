...
public class Solution {
    ...
    public static byte[] getNetAddress(byte[] ip, byte[] mask) {
        String ip2Binary, mask2Binary, netAdress2Binary;
        byte[] net = new byte[ip.length];
         ...
         // end of for-loop for each element of base array
    ...
    public static void print(byte[] bytes) {
        for(byte x : bytes){
            System.out.format("%08d ", Integer.parseInt(Integer.toBinaryString(x & 255)));
