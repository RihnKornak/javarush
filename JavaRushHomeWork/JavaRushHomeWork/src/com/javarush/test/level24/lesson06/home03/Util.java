...
public class Util {
    ...
    public static List<Jeans> getAllJeans() {
        ...
        abstract class AbstractJeans implements Jeans{
            ...
            public AbstractJeans(final int id, final int length, final int size,final double price){
                this.id = id;
                this.length = length;
                this.size = size;
                this.price = price;
        ...
        class Levis extends AbstractJeans{
            public Levis(final int id, final int length, final int size,final double price){
        ...
        class Denim extends AbstractJeans{
            public Denim(final int id, final int length, final int size,final double price){
                super( id, length, size, price);
