        ...
        int index = -1;
                ...
                try
                {
                    ...
                    return string.substring(beginIndex, index);
                        ...
                        if (FIRST_THREAD_NAME.equals(threadName)){throw new TooShortStringFirstThreadException(e); }else
                        if (SECOND_THREAD_NAME.equals(threadName)){throw new TooShortStringSecondThreadException(e);}else {
